...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            store::set_text_formatting_enabled,
            store::set_mute_system_audio_enabled,
            store::set_personal_dictionary,
            store::get_personal_dictionary,
            store::set_snippets,
            store::get_snippets,
            store::set_text_formatting_mode,
            store::export_settings_dialog,
            store::import_settings_dialog,
